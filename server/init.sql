...
CREATE TABLE "DiaChiGiaoHang" (
    "Id" integer GENERATED BY DEFAULT AS IDENTITY,
    "TaiKhoanKhachHangId" integer NOT NULL,
    "HoTen" text,
    "SoDienThoai" text,
    "DiaChiCuThe" text,
    CONSTRAINT "PK_DiaChiGiaoHang" PRIMARY KEY ("Id"),
    CONSTRAINT "FK_DiaChiGiaoHang_TaiKhoanKhachHang_TaiKhoanKhachHangId" FOREIGN KEY ("TaiKhoanKhachHangId") REFERENCES "TaiKhoanKhachHang" ("Id") ON DELETE CASCADE
);
...
VALUES ('20251101042020_Init', '9.0.9');
